// Package main_old contains the old implementation of the test client.
// This file is kept for reference only and is not used in the current setup.
package main_old
...
// OldMain is the main function from the old implementation.
func OldMain() {
